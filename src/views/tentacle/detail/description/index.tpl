<div class="mt10 detail--desc">
 <!-- <div class="mb10" v-if="data.label">
  ...
  <Selector title="人脉关系" v-model="contacts" placeholder="请选择人脉关系" :options="contactsList"></Selector> 
  <CellGroup>
    <div class="add--textarea--wrap">
      <div class="textarea--title">兴趣爱好</div>
      <textarea name="" cols="3" rows="4" class="add--text--area" maxlength="200" v-model="hobby"></textarea>
  ...
  <CellGroup class="mb50">
    <div class="add--textarea--wrap">
      ...
      <textarea name="" id="" cols="3" rows="4" class="add--text--area" maxlength="100" v-model="remark"></textarea>
