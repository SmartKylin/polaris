<div class="tentacleListView">
  ...
  <div class="bottom-notice" v-show="allLoaded">
    ...
    <router-link to="/tentacle/list?category=b1" :replace="true"  v-if="category === 'a'">看看"B1"触点有没有新单吧</router-link>
    <router-link to="/tentacle/commonality" :replace="true" v-if="category === 'b1'">去公海认领触点</router-link>
  </div>
